    ...
    <div class="pop-busarea-body">
        ...
        <div class="pop-busarea-top">
          ...
          <div class="pop-div">
            ...
            <div class="pop-word pop-m-word">
              <span>{{message.cost}}</span><span>积分抵</span><span class="pop-first-span">{{message.gain}}</span><span
              class="pop-two-span">元</span>
      ...
      <div class="pop-busarea-main">
        <div class="pop-busarea-tops" v-show="preview">
               <span>
                <div class="pop-busarea-p">
                  ...
                  <p><span>积分日消耗上限 : </span><span>{{message.totalPoint}}</span></p>
                  <!--<p><span>活动限制:</span><span>{{message.four}}</span></p>-->
                  <p><span>适用门店 : </span><span>适用{{message.shopNum}}家门店</span></p>
        ...
        <div class="pop-busarea-bottom" v-show="!preview">
              ...
              </svg>成交笔数: <span>{{datas.counts}}</span></p>
                     <p><svg class="icon" aria-hidden="true">
                <use xlink:href="#icon-jifen"></use>
              </svg>积分消耗总计: <span>{{datas.total}}</span></p>
                     <p><svg class="icon" aria-hidden="true">
                <use xlink:href="#icon-jine1"></use>
              </svg>抵扣金额总计:<span>{{datas.totalDiscount}}</span></p>
                 </div>
              </span>
          <span>

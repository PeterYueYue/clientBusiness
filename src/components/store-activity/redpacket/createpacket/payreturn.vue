...
<template>
  <div class="main">
    ...
    <div class="zj-time">
      <span>红包发放时间:</span>
      <el-date-picker v-model="form.time" type="daterange" class="zj-times" :picker-options="pickerOptions2" placeholder="选择时间范围" @change="timeChange()" align="right">
      </el-date-picker>
    </div>
    <div class="zj-shop">
      <span>适用门店:</span>
    ...
    <div class="zj-degree" v-if="routerId==1 || routerId==2 ">
      ...
      领取
      <el-input v-model="form.degree" class="zj-number" placeholder="次数" style="position:realtive;top:-2px;"></el-input>
    </div>
        ...
        <div class="main_right">
          <div class="right_box">
            <div class="right_box_title">
              <span>商品名称</span>
              <el-input class="right_query_input" size="small" v-model="food.name" placeholder="请输入商品名称"></el-input>
              <span>价格</span>
...
export default {
  ...
  methods: {
    sumite: function() {
      ...
      this.$http.post(`${ipAddress}/front/ali_cash_activity!saveAliCashActivity.action`, data)
        .then(res => {
           this.$message({
          ...
          if (res.data.errorCode == 10000) {
            this.$router.push('/packetactivelist')
          }
        });
    },
    timeChange: function() {

    ...
    <div class="zj-main">
        <div class="ticket_show">
            <div>
                ...
                <span  v-if="this.qlist[0].radio == '1'" >{{money}}元</span>
                <span  v-if="this.qlist[0].radio == '2'" >{{money}}折</span>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            changeStartTime(){
                this.startTime = this.form.activeStartDate.toLocaleDateString()
            },
            changeEndTime(){
                this.endTime =  this.form.activeEndDate .toLocaleDateString()
            },
            minCostblur(){
            ...
            sumbitdata(){
                ...
                if(this.form.activeStartDate.getTime()+3600000>this.form.activeEndDate.getTime()){
                    this.$message.error('活动时间不能小于一个小时');
                    return;
                }
                if(this.form.investmentStartDate.getTime() > this.form.investmentEndDate.getTime() - - 600000){
                    this.$message.error('门店确认结束时间过短');
                    return;
                }  
                ...
                for(let i = 0 ; i <this.qlist.length ; i++){
                    ...
                    let validitysTime = this.qlist[i].validitytime
                    ...
                    var yxtime2 = new Date(this.qlist[i].validitytime[1]).getTime() - - 3599000
                    ...
                    if(this.qlist[i].radio == '1'){
                        ...
                        if(discountRe.test(this.qlist[i].discount)){
                            ...
                            this.$message.error(this.qlist[i].title+'填写范围为1.1~9.9')
                            this.qlist[i].discount = ' ';
                            return
                        }
                    ...
                    if(this.qlist[i].validitytimevalue == 'RELATIVE'){                       
                        ...
                        if( new Date(this.qlist[i].validitytime[1]).getTime() < this.form.activeStartDate.getTime()){
                            this.$message.error(this.qlist[i].title + '有效期时间不合理');
                            return;
                        }
                        // if( new Date(validitysTime[1]).getTime()>this.form.activeEndDate.getTime() ){
                        //     this.$message.error(this.qlist[i].title + '有效期时间不合理');
                        //     return;
                        // }
                    }
                    ...
                    if(this.qlist[i].timelimitselectvalue == '2'){    
                        console.log(this.qlist[i].timelist,"可用时间段")
                        let newArrTime = []
                        this.qlist[i].timelist[0].times.forEach(e =>{
                            if(e.value.length){
                                newArrTime.push({
                    ...
                    if(this.qlist[i].nousetimevalue  == '2'){
                        console.log(this.qlist[i].nousetimes_data,"不可用时间")
            ...
            setdatatosumbit(){
                ...
                this.sumbit_data = {
                 ...
                 console.log(this.inverstmentJsondata,"提交的信息")
                return 

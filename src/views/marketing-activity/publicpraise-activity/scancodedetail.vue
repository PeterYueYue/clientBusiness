        ...
        <div class="ticket_rule ticket_rule_zs bottom_margin_50">
            ...
            <el-form ref="form" :model="form" label-width="140px">
                ...
                <el-form-item  label="活动对象 :">
                    <span  >消费满 {{form.minCost}} 元的顾客</span>
                </el-form-item>
                        ...
                        >
                            <el-form class="margin_top_5"  label-width="140px">
                                <el-form-item label="券种类 :">
                                    ...
                                    <span v-if="item.voucherType == 'MONEY'">代金券</span>
                                </el-form-item>
                                <el-form-item label="适用门店 :">
                                    <span>共 {{item.showshopslistnumber}} 家门店</span>
                                    <el-button type="text" class="click_table" @click="dialogVisible_shopslist_quan = true">点击查看</el-button>
                                </el-form-item>

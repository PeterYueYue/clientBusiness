                        ...
                        >
                            <el-form class="margin_top_5" ref="item" :rules="rules" :model="item" label-width="140px">
                                ...
                                <el-form-item class="ticket_title" label="品牌名称 :" required >
                                    <el-input size="small" v-model="item.brandName" maxlength="32" placeholder="请输入品牌名称"></el-input>
                                </el-form-item>
                                ...
                                <el-form-item class="ticket_width200" label="使用说明 :" required>
                                    <div class="marrgin_b_10" v-for="(desitem,i) in item.usedeslist">
                                        <el-input size="small" v-model="desitem.des" placeholder="请输入100字以内的说明" maxlength="100"></el-input>
                                ...
                                <el-form-item  class="ticket_limit" label="可使用时间段 :">
                                    ...
                                    <br>
                                    <div class="bgf4f4f4"  v-if="item.timelimitselectvalue == '2'">
                                        <div class="timeitem" v-for="(item12,inde) in item.timelist">
        ...
        methods: {
            ...
            setdatatosumbit(){
                ...
                for(let i = 0 ; i < this.qlist.length; i++){
                    ...
                    for(let a = 0;a<this.qlist[0].usedeslist.length;a++){
                    ...
                    this.inverstmentJsondata.push(
                        {
                            ...
                            urlLogo:'http://b.tingzhijun.com/coupons/upload/201709/d3bd0588eff34776a0e947d4e9fcd05e/f5819c76b7074bfd8b97f8b05be196de.jpg',
                            receiveMax:'1',
                ...
                this.sumbit_data = {
                    ...
                    'investment.investmentEndDate':formateDate(this.form.investmentEndDate)+" 23:59:59",
                    'investment.activeStartDate':formDateSecond(this.form.activeStartDate),
                    'investment.activeEndDate':formateDate(this.form.activeEndDate)+" 23:59:59",
                    'investment.minCost':'0.01',
                    'investment.investmentShops':'',
